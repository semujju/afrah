  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <div class="text-center"><a href="#" class="menuzord-brand"><img src="../img/logos/logo2.jpg" alt="#"></a></div>
        <div class="clearfix"></div>
        <p class="white">Contact us: </p>
        <ul>
          <li><a href="#"> <i class="fa fa-map-marker fa-2x"></i>Plot 205,Hills House, 1st Floor, <br>Kibuye-Entebbe Road</br>P.O.BOX 7090 Kampala - Uganda</a></li>
          <li><a href="#"><i class="fa fa-envelope-o fa-2x"></i>afrahagencies@gmail.com</a></li>
          <li><a href="#"><i class="fa fa-phone fa-2x"></i>+256 414 510 419, 256 752 502 164</a></li>
        </ul>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        <div class="title">
        ...
        <div class="information">
          <ul>
            <li><a href="../pages/pages.php?page=home"> About us</a></li>
            <li><a href="../pages/pages.php?page=activities"> Our Activies</a></li>
            <li><a href="#"> Testimonials</a></li>
            <li><a href="#"> Our Donors</a></li>
            <li><a href="../pages/pages.php?page=gallery"> Our Gallery</a></li>
      ...
      <div class="col-lg-3 col-md-3 col-sm-12 col-xs-12">
        ...
        <div class="our-service">
          <ul>
            <li><a href="../more-pages/more_pages.php?page=relief">Emergency Relief</a></li>
            <li><a href="../more-pages/more_pages.php?page=health">Health and Medical Care</a></li>
            <li><a href="../more-pages/more_pages.php?page=water">Water and Sanitation</a></li>
            <li><a href="../more-pages/more_pages.php?page=orphans">Orphans and Needy Support</a></li>
            <li><a href="../more-pages/more_pages.php?page=aid">Micro Aid Project</a></li>
            <li><a href="../more-pages/more_pages.php?page=education">Education Support</a></li>
            <li><a href="../more-pages/more_pages.php?page=mosque">Mosque Construction and Renovation</a></li>
            <li><a href="../more-pages/more_pages.php?page=environment">Environmental Protection and Reservation</a></li>
            <li><a href="../more-pages/more_pages.php?page=season">Season Programs</a></li>
          </ul>
        </div>
      </div>
      <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
        ...
        <div class="popular-post">
          <ul>
            <li> <span class="post-date">26 May, 2018</span> <a href="index2.html#">Optimizing your Website for Mobile Searchwhen an unkn.</a> </li>
            <li> <span class="post-date">12 June, 2018</span> <a href="index2.html#">Optimizing your Website for Mobile Searchwhen an unkn.</a> </li>
            <li> <span class="post-date">09 July, 2018</span> <a href="index2.html#">Optimizing your Website for Mobile Searchwhen an unkn.</a> </li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
        <div class="copy-right">
          <p>Afrah Development and Relief Agency Uganda © 2018 </p>
        </div>
      </div>
